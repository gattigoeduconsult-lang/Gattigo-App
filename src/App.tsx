...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-gray-800 selection:bg-[#E51B13] selection:text-white">
      
      {/* SUCCESS TOAST MESSAGE */}
      <AnimatePresence>
        {successToast && (
          <motion.div
            className="fixed top-24 left-6 right-6 md:left-auto md:right-6 z-50 p-4 rounded-xl bg-slate-900 text-white shadow-2xl border border-red-500 max-w-md flex items-start gap-3"
            initial={{ opacity: 0, y: -20, scale: 0.95 }}
            animate={{ opacity: 1, y: 0, scale: 1 }}
            exit={{ opacity: 0, y: -20, scale: 0.95 }}
          >
            <Sparkles className="h-5 w-5 text-[#E51B13] shrink-0 mt-0.5" />
            <div>
      ...
      <header className="sticky top-0 z-40 bg-[#080F81] text-white shadow-[#292133]/30 shadow-md">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            {/* Logo */}
            <a href="#" className="flex items-center gap-3 group focus:outline-none">
              <img 
                src="/Images/Gattigo%20Main%20Logo.jpeg" 
                alt="Gattigo Logo" 
                className="h-12 w-auto max-w-[130px] object-contain rounded-xl bg-white p-1 border-2 border-white/20 shadow-md group-hover:scale-105 transition duration-300"
              />
              <div className="hidden xs:block">
                <span className="block font-display text-lg font-black tracking-tight leading-none text-white">
                  GATTIGO
                </span>
                <span className="block text-[8px] tracking-widest text-red-400 font-bold uppercase leading-none mt-1">
                  Edu Consult
                </span>
              </div>
            </a>
            ...
            <nav className="hidden lg:flex items-center gap-8 text-sm font-medium">
              <a href="#destinations-grid" className="text-blue-100 hover:text-red-400 transition">Destinations</a>
              <a href="#explore-services" className="text-blue-100 hover:text-red-400 transition font-sans">Services</a>
              <a href="#success-community" className="text-blue-100 hover:text-red-400 transition">Community</a>
              <a href="#popular-courses" className="text-blue-100 hover:text-red-400 transition">Courses</a>
              <a href="#scholarships-block" className="text-blue-100 hover:text-red-400 transition">Scholarships</a>
              <a href="#educational-resources" className="text-blue-100 hover:text-red-400 transition">Advice</a>
              <a href="#steps-accordion" className="text-blue-100 hover:text-red-400 transition">Process</a>
            </nav>
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className={`relative px-4 py-2 border rounded-xl text-xs font-bold transition flex items-center gap-2 ${portalOpen ? 'bg-[#E51B13] text-white border-[#E51B13]' : 'bg-[#292133]/60 border-blue-500/30 text-blue-200 hover:text-white hover:bg-blue-900/40'}`}
              >
                <span>Portal Desktop</span>
                <span className="relative flex h-2 w-2">
                  <span className={`animate-ping absolute inline-flex h-full w-full rounded-full opacity-75 ${bookings.length > 0 ? 'bg-emerald-400' : 'bg-red-400'}`}></span>
                  <span className={`relative inline-flex rounded-full h-2 w-2 ${bookings.length > 0 ? 'bg-emerald-400' : 'bg-red-400'}`}></span>
                </span>
              </button>
              
              <a
                href="#expert-guidance-section"
                className="hidden sm:inline-block px-5 py-2.5 rounded-xl bg-[#E51B13] hover:bg-[#b0130c] text-white text-xs font-bold tracking-wide uppercase transition duration-200 hover:shadow-lg focus:outline-none"
              >
                Free Consultation
              </a>
            </div>
      ...
      <section id="hero-banner" className="relative bg-slate-950 text-white overflow-hidden py-16 lg:py-24">
        ...
        <div className="absolute top-0 right-0 w-96 h-96 bg-red-500/10 rounded-full blur-3xl z-0 pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              <span className="inline-flex items-center gap-1.5 px-3.5 py-1 text-xs font-semibold bg-red-500/20 text-red-400 rounded-full border border-red-500/30 animate-pulse-slow">
                <Sparkles className="h-3.5 w-3.5 text-[#E51B13]" />
              ...
              <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight leading-none text-white">
                Study Abroad <br />
                <span className="text-[#E51B13]">With Confidence</span>
              </h1>
              ...
              <div className="flex flex-wrap gap-4 items-center pt-2">
                <a
                  href="#expert-guidance-section"
                  className="px-6 py-3.5 rounded-xl bg-[#E51B13] hover:bg-[#b0130c] text-white font-bold text-sm tracking-wide shadow-lg hover:shadow-red-500/20 transition flex items-center gap-2"
                >
                  Free Consultation
              ...
              <div className="grid grid-cols-3 gap-4 pt-6 border-t border-white/10 text-white">
                <div>
                  <span className="block text-2xl font-extrabold text-[#E51B13]">98.2%</span>
                  <span className="block text-xs text-blue-200">Visa Success Rate</span>
                </div>
                <div>
                  <span className="block text-2xl font-extrabold text-[#E51B13]">2500+</span>
                  <span className="block text-xs text-blue-200">Visas Approved</span>
                </div>
                <div>
                  <span className="block text-2xl font-extrabold text-[#E51B13]">50+</span>
            ...
            <div className="lg:col-span-5">
              <div className="bg-white rounded-3xl p-6 md:p-8 text-gray-900 shadow-2xl border border-gray-100 flex flex-col gap-6">
                <div className="flex items-center gap-4 border-b border-gray-100 pb-4">
                  <div className="h-14 w-14 shrink-0 rounded-full overflow-hidden bg-red-100 border-2 border-[#E51B13]">
                    <img
                  ...
                  <div>
                    <h3 className="font-bold text-base text-[#080F81] leading-snug">Quick Admission Inquiry</h3>
                ...
                <form onSubmit={handleHeroSubmit} className="space-y-4">
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <select
                        ...
                        className="w-full text-xs rounded-xl border border-gray-200 p-2.5 outline-none focus:border-[#080F81] bg-slate-50 font-medium"
                      >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full text-xs rounded-xl border border-gray-200 p-2.5 outline-none focus:border-[#080F81] bg-slate-50"
                    />
                  </div>
                  ...
                  <button
                    type="submit"
                    className="w-full py-3 rounded-xl bg-[#080F81] hover:bg-[#292133] text-white font-bold text-xs uppercase tracking-wide transition duration-200 focus:outline-none"
                  >
      ...
      <section id="why-trust-gattigo" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <span className="text-xs font-bold uppercase tracking-wider text-[#E51B13] bg-red-50 px-3.5 py-1.5 rounded-full">
              Built on Integrity
            </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="p-6 rounded-2xl bg-slate-50 border border-gray-100 shadow-sm hover:shadow-md hover:border-blue-200 transition group">
              <span className="flex h-12 w-12 items-center justify-center rounded-xl bg-[#080F81] text-white text-lg font-bold group-hover:scale-105 transition">
                🏫
              </span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 bg-white rounded-3xl p-6 md:p-8 shadow-xl border border-gray-100">
              <div className="mb-6">
                <span className="text-xs font-bold text-[#E51B13] uppercase tracking-wider">Book Free Counseling</span>
                <h3 className="font-display font-bold text-2xl text-[#080F81] mt-1">Submit Academic Evaluation File</h3>
              ...
              <form onSubmit={handleExpertSubmit} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full text-xs rounded-xl border border-gray-200 p-3 outline-none focus:border-[#080F81] focus:ring-1 focus:ring-[#080F81]"
                    />
                  </div>
                  <div>
                ...
                <button
                  type="submit"
                  className="w-full py-3.5 rounded-xl bg-[#E51B13] hover:bg-[#b0130c] text-white text-xs font-bold uppercase tracking-wider transition hover:shadow-md"
                >
            ...
            <div className="lg:col-span-5 space-y-6">
              <div className="relative rounded-3xl overflow-hidden h-96 group">
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <span className="text-[10px] uppercase font-bold tracking-widest text-[#E51B13] bg-red-950/80 px-2 py-1 rounded inline-block mb-2">
      ...
      <section id="what-you-should-know" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Card 1 */}
            <div className="rounded-2xl border border-gray-100 shadow-sm p-5 space-y-4 flex flex-col justify-between hover:border-[#E51B13]/30 bg-slate-50 transition">
              <div className="space-y-2">
                <span className="text-[10px] font-bold text-red-500 uppercase">Canada Pathways</span>
              ...
              <button
                ...
                className="text-xs font-bold text-[#080F81] hover:text-[#E51B13] transition inline-flex items-center gap-1 mt-2 text-left"
              >
            ...
            <div className="rounded-2xl border border-gray-100 shadow-sm p-5 space-y-4 flex flex-col justify-between hover:border-[#E51B13]/30 bg-slate-50 transition">
              <div className="space-y-2">
                <span className="text-[10px] font-bold text-[#080F81] uppercase">Tuition Control</span>
      ...
      <section id="destinations-grid" className="py-20 bg-slate-50 border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <span className="text-xs font-bold uppercase tracking-wider text-[#E51B13] bg-red-100 px-3.5 py-1.5 rounded-full">
              Global Gateways
            </span>
              ...
              >
                <div>
                  ...
                  <div className="p-4 space-y-2">
                    <div className="flex items-center justify-between text-xs text-gray-500">
                      ...
                      <span className="bg-blue-50 text-[#080F81] font-bold px-2 py-0.5 rounded text-[10px]">
                ...
                <div className="p-4 pt-0 border-t border-gray-100 flex gap-2 mt-2">
                  <button
                    ...
                    className="flex-1 py-1.5 rounded-lg text-[11px] font-bold text-[#080F81] bg-slate-100 hover:bg-slate-200 transition"
                  >
                    View Details
                  </button>
                  <button
                    ...
                    className="flex-1 py-1.5 rounded-lg text-[11px] font-bold text-white bg-[#E51B13] hover:bg-red-600 transition"
                  >
                    Apply Now
                  </button>
                </div>
      ...
      <section id="explore-services" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Card 1 */}
            <div className="p-6 rounded-2xl bg-slate-50 border border-gray-200 hover:border-[#080F81] transition flex gap-4">
            ...
            {/* Card 2 */}
            <div className="p-6 rounded-2xl bg-slate-50 border border-gray-200 hover:border-[#E51B13] transition flex gap-4">
              <span className="h-10 w-10 shrink-0 rounded-full bg-red-100 text-[#E51B13] flex items-center justify-center font-bold">🛂</span>
              <div>
      ...
      <section id="how-helps-you" className="py-20 bg-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <h2 className="font-display text-3xl sm:text-4xl font-extrabold tracking-tight mt-3 text-[#080F81]">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={idx} className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm space-y-2 flex flex-col justify-between group hover:border-[#080F81] transition">
                <div className="space-y-2">
                  <span className="text-[10px] font-bold text-[#E51B13] font-mono block">STAGE 0{step.id}</span>
      ...
      <section id="success-community" className="py-20 bg-gradient-to-tr from-[#080F81] to-[#292133] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            
            {/* Left: Stats & Communities */}
            <div className="lg:col-span-6 space-y-6">
              <span className="text-xs font-bold uppercase tracking-wider text-red-400 bg-red-950/40 border border-red-500/20 px-3.5 py-1 rounded-full animate-pulse-slow">
                Gattigo Community
              </span>
              <h2 className="font-display text-3xl sm:text-4xl font-extrabold tracking-tight">
                Our Nigerian Scholars <br />
                <span className="text-[#E51B13]">Success Community</span>
              </h2>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 rounded-xl bg-white/5 border border-white/10 text-center">
                  <CheckCircle2 className="h-6 w-6 text-[#E51B13] mx-auto mb-2" />
                ...
                <div className="p-4 rounded-xl bg-white/5 border border-white/10 text-center">
                  <Users className="h-6 w-6 text-[#E51B13] mx-auto mb-2" />
                ...
                <div className="p-4 rounded-xl bg-white/5 border border-white/10 text-center">
                  <Compass className="h-6 w-6 text-[#E51B13] mx-auto mb-2" />
                ...
                <div className="p-4 rounded-xl bg-white/5 border border-white/10 text-center">
                  <Globe className="h-6 w-6 text-[#E51B13] mx-auto mb-2" />
            ...
            <div className="lg:col-span-6 bg-white/5 border border-white/10 rounded-3xl p-6 md:p-8 space-y-4">
              <h3 className="font-semibold text-sm uppercase text-[#E51B13] tracking-wider border-b border-white/10 pb-2 flex items-center gap-1.5">
                🌍 Fast Fact Check
              </h3>
              ...
              <div className="rounded-2xl overflow-hidden h-48 relative border border-white/10 mt-4 group">
                ...
                <div className="absolute inset-0 bg-blue-900/60 p-4 flex flex-col justify-between">
                  <span className="inline-block bg-[#E51B13] text-white font-bold text-[9px] uppercase px-2 py-0.5 rounded leading-none">
      ...
      <section id="student-stories" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <span className="text-xs font-bold uppercase tracking-wider text-red-500 bg-red-50 px-3.5 py-1.5 rounded-full">
              Testimonials
            </span>
            <h2 className="font-display text-3xl sm:text-4xl font-extrabold tracking-tight mt-3 text-gray-900">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {TESTIMONIALS.map((t) => (
              ...
              >
                <div>
                  <div className="flex items-center gap-3">
                    <div className="h-12 w-12 rounded-full overflow-hidden border-2 border-[#E51B13]">
                      <img
                        src={t.portrait}
                        alt={t.name}
                        className="h-full w-full object-cover"
                    ...
                    <div>
                      ...
                      <p className="text-[11px] text-[#080F81] font-semibold mt-0.5">{t.university}</p>
                    </div>
                  </div>
                ...
                <div className="pt-4 border-t border-gray-100 flex items-center justify-between text-xs text-slate-500 mt-4">
                  <span className="font-bold underline text-[#080F81]">{t.destination} ({t.course.split(' ')[0]})</span>
                  <span className="text-[10px] uppercase font-bold tracking-widest text-[#E51B13] bg-red-50 px-2 py-0.5 rounded flex items-center gap-1">
                    🎥 Success Vlog
                  </span>
                </div>
              </div>
      ...
      <section id="steps-accordion" className="py-20 bg-slate-50 border-t border-gray-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            <span className="text-xs font-bold uppercase tracking-wider text-[#080F81] bg-blue-50 px-3.5 py-1.5 rounded-full">
              ...
              return (
                <div key={step.step} className="py-4 first:pt-0 last:pb-0">
                  <button
                    ...
                    className="w-full flex items-center justify-between text-left font-display font-bold text-gray-900 py-2 hover:text-[#080F81] transition outline-none"
                  >
                    <span className="flex items-center gap-3">
                      <span className="flex h-7 w-7 items-center justify-center rounded-lg bg-red-100 text-[#E51B13] text-xs font-mono font-bold leading-none shrink-0">
                        0{step.step}
                      </span>
                      <span className="text-xs sm:text-sm">{step.title}</span>
                    </span>
                    <ChevronDown className={`h-5 w-5 text-gray-400 shrink-0 transition ${isOpen ? 'rotate-180 text-[#E51B13]' : ''}`} />
                  </button>
                  <AnimatePresence>
                    {isOpen && (
                      <motion.div
                      ...
                      >
                        ...
                        <div className="pl-10 mt-1 pb-2">
                          <a
                            href="#expert-guidance-section"
                            className="inline-flex items-center gap-1 text-[11px] font-bold text-[#E51B13] hover:underline"
                          >
          ...
          <div className="bg-slate-50 border border-gray-100 p-6 rounded-3xl relative">
            ...
            <div className="text-center mt-6">
              <p className="text-xs text-gray-500">
                ...
                <a href="#expert-guidance-section" className="text-[#E51B13] font-bold hover:underline">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-1.5 mb-10 bg-white border border-gray-200 p-2 rounded-2xl max-w-4xl mx-auto">
            {categories.map((cat) => (
              <button
                ...
                className={`px-3 py-1.5 rounded-xl text-xs font-semibold transition ${courseFilter === cat ? 'bg-[#080F81] text-white' : 'text-gray-600 hover:bg-slate-100 hover:text-[#080F81]'}`}
              >
                {cat}
              </button>
            ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredCourses.slice(0, 9).map((course) => (
              <div key={course.id} className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between hover:border-red-200 transition">
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="text-[10px] font-bold text-[#E51B13] uppercase tracking-wide bg-red-50 px-2.5 py-1 rounded-full">
                      {course.category}
                    </span>
                ...
                <div className="pt-4 border-t border-gray-100 mt-4 flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="px-3 py-1 rounded-lg text-[10.5px] font-bold bg-[#080F81] text-white hover:bg-[#E51B13] transition"
                  >
                    Select Program
                  </button>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {SCHOLARSHIPS.map((sch) => (
              ...
              >
                <div>
                  <div className="flex items-center justify-between">
                    <span className="bg-[#080F81] text-white text-[9px] font-bold uppercase tracking-wider px-2 py-0.5 rounded">
                      {sch.type}
                    </span>
                    <span className="text-xs font-semibold text-red-500 font-mono">{sch.destination}</span>
                  </div>
                  ...
                  <div className="mt-4 p-3 rounded-xl bg-red-50/50 border border-red-100 space-y-1 text-xs">
                ...
                <div className="pt-4 border-t border-gray-200 mt-4 flex items-center justify-between font-mono text-[10px] text-gray-400">
                  ...
                  <button
                    ...
                    className="text-[#080F81] font-bold text-[11px] underline group-hover:text-[#E51B13] transition"
                  >
                    View Criteria
                  </button>
                </div>
              ...
              >
                <div className="space-y-3">
                  <div className="flex items-center justify-between text-xs text-gray-400 font-semibold font-mono">
                    <span className="text-[#E51B13]">{blog.category}</span>
                    <span>{blog.date}</span>
                  </div>
                ...
                <div className="pt-4 border-t border-gray-100 flex items-center justify-between text-xs">
                  <span className="text-[#080F81] font-bold underline flex items-center gap-1">
      ...
      <section id="final-cta" className="py-20 bg-[#080F81] text-white relative overflow-hidden">
        {/* Ambient backing backdrop decor */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-4xl h-80 bg-red-600/20 rounded-full blur-3xl" />

        <div className="max-w-4xl mx-auto px-4 sm:px-6 relative z-10 text-center space-y-6">
          <span className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-[#E51B13] text-white text-xl font-bold shadow-lg shadow-red-500/20 mb-2">
            ✈️
          </span>
          ...
          <div className="pt-4 flex flex-col sm:flex-row justify-center items-center gap-3">
            <a
              href="#expert-guidance-section"
              className="w-full sm:w-auto px-8 py-3.5 rounded-xl bg-[#E51B13] hover:bg-[#b0130c] text-white font-bold text-sm tracking-wide shadow-lg uppercase transition"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
            ...
            <div className="space-y-4 lg:col-span-2">
              <img 
                src="/Images/Gattigo%20Main%20Logo.jpeg" 
                alt="Gattigo Logo" 
                className="h-14 w-auto max-w-[150px] object-contain rounded-xl bg-white p-1.5 border border-slate-700 shadow-md"
              />
              <h4 className="font-display font-extrabold text-[#E51B13] text-lg uppercase tracking-wider">GATTIGO EDU CONSULT</h4>
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="space-y-2 text-xs">
                  ...
                  <p className="text-gray-500 leading-relaxed">
                    Visa decisions in West Africa typically occupy <strong className="text-red-500">{selectedDestination.visaProcessingTime}</strong>. Host cities like <strong className="text-slate-800">{selectedDestination.popularCities.join(', ')}</strong> host top campuses. High WAEC or IELTS grades are highly beneficial.
                  </p>
                </div>
                ...
                <div className="flex gap-2 pt-2">
                  ...
                  <button
                    ...
                    className="flex-1 py-2.5 rounded-xl text-xs font-bold text-white bg-[#E51B13] hover:bg-red-600 transition"
                  >
                    Select Destination
                  </button>
                </div>
            ...
            >
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <span className="text-xs text-[#E51B13] block mt-1 font-semibold">{selectedScholarship.destination}</span>
                </div>
                <button
                  onClick={() => setSelectedScholarship(null)}
              ...
              <div className="space-y-3 text-xs leading-relaxed">
                <div className="p-3 rounded-xl bg-red-50 border border-red-100">
                  <span className="block font-bold text-[#E51B13] font-mono text-[9px] uppercase">Grants Worth</span>
              ...
              <div className="pt-4 flex gap-2 border-t border-gray-100">
                ...
                <button
                  ...
                  className="flex-1 py-2.5 rounded-xl text-xs font-bold bg-[#E51B13] text-white hover:bg-red-600 transition"
                >
            ...
            >
              ...
              <div className="relative h-64 overflow-hidden shrink-0">
                ...
                <div className="absolute bottom-4 left-6 right-6">
                  <span className="text-[10px] uppercase font-bold tracking-widest text-[#E51B13] bg-red-950/80 px-2 py-1 rounded inline-block mb-1.5">
              ...
              <div className="p-4 border-t border-gray-100 bg-slate-50 flex justify-between items-center shrink-0">
                ...
                <button
                  onClick={() => setSelectedBlog(null)}
                  className="px-6 py-2 rounded-xl bg-[#080F81] text-white text-xs font-bold hover:bg-[#E51B13] transition"
                >
                  Close Article
                </button>
              </div>
            ...
            >
              ...
              <div className="space-y-3 leading-relaxed text-xs">
                ...
                <div className="flex items-center justify-between text-xs font-bold text-slate-700">
                  ...
                  <span className="text-[#E51B13]">{selectedTestimonial.course}</span>
                </div>

                <div className="p-3 rounded-lg bg-red-50 border border-red-100 text-[11px] leading-snug flex items-start gap-2 text-slate-700">
